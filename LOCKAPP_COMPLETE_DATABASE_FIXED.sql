-- =====================================================
-- LOCKAPP COMPLETE DATABASE STRUCTURE (FIXED)
-- =====================================================
-- Bu script LockApp projesi için kapsamlı veritabanı yapısı oluşturur
-- CHECK constraint subquery hataları düzeltildi
...
-- Device-user role validation function (trigger ile çalışır)
...
-- Başarı mesajı
SELECT 'LockApp database structure created successfully! (FIXED VERSION)' as status,
       'Tables: users, devices, device_pairings, app_list, lock_commands, usage_stats' as tables,
       'All RLS policies, triggers, and indexes created without CHECK constraint errors' as security; 